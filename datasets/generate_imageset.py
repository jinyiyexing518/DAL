...
def generate_iamgets(dataset=None):
    ...
    if dataset  == 'DOTA':
        ...
        trainset = r'../HRSC2016/ImageSets/train.txt'
        valset = r'../HRSC2016/ImageSets/valid.txt'
        testset = r'../HRSC2016/ImageSets/test.txt'
        img_dir = r'./HRSC2016/Train/AllImages'
        label_dir = r'../HRSC2016/Train/Annotations'
        root_dir = r'../HRSC2016'
    ...
    for dataset in [trainset, testset, valset]:
            with open(dataset,'r') as f:
                ...
                if DATASET in ['HRSC2016', 'NWPU_VHR']:
                    paths = [os.path.join(img_dir,x.strip()+'.bmp\n') for x in names]
